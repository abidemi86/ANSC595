...
my_colors <- c(
  ...
  "#8569D5", "#5E738F","#D1A33D", "#8A7C64", "#599861", "gray", "black", "purple", "orange", "pink", "brown", "yellow"
)
...
my_contrast = c("delivery_mode", "Pre-labor .CS", "Post-labor .CS") 
my_contrast = c("delivery_mode", "Vaginal", "Post-labor .CS") 
